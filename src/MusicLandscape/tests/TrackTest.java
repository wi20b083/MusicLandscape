...
public class TrackTest {
   ...
   */
	private <T> Field getPrivateField(final T myObject, final String fieldName){
  ...
  public void testtoString(final String title, final Artist w, final String wName, final Artist p, final String pName, final int d, final String out) {
		...
		for (final Object[] li : myList){
			try {
				this.getPrivateField(this.toTest, li[0].toString()).set(this.toTest,li[1]);
